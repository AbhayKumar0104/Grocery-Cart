        ...
        <div className="max-w-6xl w-full  mt-14">
            ...
            <div className='flex flex-col items-center mt-20'>
                <div className='flex flex-col items-center w-max'>
                    ...
                    <div className='w-20 h-0.5 bg-primary rounder-full mt-2'></div>
                </div>

                <div className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 md:gap-6 lg:grid-cols-5 mt-6 w-max'>
                ...
                <button onClick={()=> {navigate('/products') ; scrollTo(0,0)}}
                 className='mx-auto curson-pointed px-12 my-16 py-2.5 border rounded text-primary hover:bg-primary/10 transition'>
                    See more
                </button>
            </div>
        </div>
